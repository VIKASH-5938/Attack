...
def get_status(active_inactive,):
    ...
    status_message = (
        ...
        "━━━━━━━━━━━━━━━\n"
        f"👤 𝗨𝘀𝗲𝗿: {user.first_name} {user.last_name}\n"  # Use username here
        f"🆔 𝗜𝗗:- `{user.id}` \n\n"  # Use user_id here
        "💎 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻:\n"
